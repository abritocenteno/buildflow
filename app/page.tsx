        ...
        <div className="min-h-screen bg-white">
            ...
            <nav className="border-b border-zinc-100 px-6 h-16 flex items-center justify-between max-w-7xl mx-auto">
                <div className="flex items-center gap-2.5">
                    <Image src="/arcocen-logo.png" alt="Arcocen" width={32} height={32} className="rounded-lg" />
                    <span className="font-bold text-xl tracking-tight">Arco<span className="text-sky-500">cen</span></span>
                </div>
                <SignInButton mode="redirect">
                    <button className="bg-sky-500 hover:bg-sky-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition-colors">
                        Open Dashboard
                    </button>
                </SignInButton>
            </nav>
            ...
            <section className="max-w-5xl mx-auto px-6 pt-24 pb-16 text-center">
                ...
                <p className="text-xl text-zinc-500 max-w-2xl mx-auto mb-10">
                    Arcocen gives contractors the tools to quote jobs, track projects, manage subcontractors, and invoice clients — all in one place.
                </p>
                <div className="flex items-center justify-center gap-4">
                    <SignInButton mode="redirect">
                        <button className="bg-sky-500 hover:bg-sky-600 text-white px-8 py-4 rounded-2xl text-base font-bold transition-colors shadow-lg shadow-sky-500/25">
                            Go to Dashboard
                        </button>
                    </SignInButton>
                    <Link
            ...
            <footer className="border-t border-zinc-100 py-8 text-center text-xs text-zinc-400">
                Arcocen — Construction Management Platform
            </footer>
        </div>
    );
}
